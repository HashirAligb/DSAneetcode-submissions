class Solution:
    def findOrder(self, numCourses: int, prerequisites: List[List[int]]) -> List[int]:
        ...
        # key ** If you visit a course already in cycle, it means you're revisiting it before finishing its prerequisites, which forms a cycle (invalid).** 
        # key ** Tracks courses that have already been fully processed. ** 
